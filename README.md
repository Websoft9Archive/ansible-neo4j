...
#自动化安装命令
wget https://raw.githubusercontent.com/Websoft9/linux/master/ansible_script/install.py ; python install.py playb=neo4j url=https://github.com/Websoft9/ansible-neo4j.git init=0 ansible=y
